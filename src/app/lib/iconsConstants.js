...
const IconSend = ({ color = "#ffffff", strokeWidth = "1.5", size = 24 }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-send" width={size} height={size} viewBox="0 0 24 24" strokeWidth={strokeWidth} stroke={color} fill="none" strokeLinecap="round" strokeLinejoin="round">
        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        <path d="M10 14l11 -11" />
...
export { IconMic, IconMutedMic, IconExit, IconLogout, IconCamera, IconMutedCamera, IconSend }